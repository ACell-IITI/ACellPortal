...
const AdminDashboard = () => {
  ...
  const fetchSponsors = async () => {
    try {
      const res = await axios.get("http://alumnicell.iiti.ac.in:3008/api/sponsors");
  ...
  const handleAddSponsor = async (e) => {
    ...
    try {
      ...
      await axios.post("http://alumnicell.iiti.ac.in:3008/api/admin/add-sponsor", data, {
  ...
  const handleDeleteSponsor = async (id, name) => {
    ...
    try {
      await axios.delete(
        `http://alumnicell.iiti.ac.in:3008/api/admin/delete-sponsor/${id}`
      );
      fetchSponsors();
    } catch (err) {
  ...
  const handleSubmitGallery = async (e) => {
    ...
    try {
      const res = await fetch("http://alumnicell.iiti.ac.in:3008/api/gallery", {
        method: "POST",
        body: formData,
      });
  ...
  useEffect(() => {
    fetch("http://alumnicell.iiti.ac.in:3008/api/gallery")
      .then((res) => res.json())
  ...
  const handleDeleteGallery = async (id) => {
    try {
      await fetch(`http://alumnicell.iiti.ac.in:3008/api/gallery/${id}`, {
        method: "DELETE",
      });
