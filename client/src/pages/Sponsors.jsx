...
const sponsors = [
  {
    id: 1,
    name: "Classmate",
    type: "Stationery Sponsor",
    icon: <BookOpen className="w-10 h-10 sm:w-12 sm:h-12 text-indigo-600" />,
  },
  {
    id: 2,
    name: "ABC Corporation",
    type: "Title Sponsor",
    icon: <Award className="w-10 h-10 sm:w-12 sm:h-12 text-indigo-600" />,
  },
  {
    id: 3,
    name: "XYZ Pvt Ltd",
    type: "Event Sponsor",
    icon: <Building2 className="w-10 h-10 sm:w-12 sm:h-12 text-indigo-600" />,
  },
  {
    id: 4,
    name: "Innovate Labs",
    type: "Knowledge Partner",
    icon: <Lightbulb className="w-10 h-10 sm:w-12 sm:h-12 text-indigo-600" />,
  },
  {
    id: 5,
    name: "TechVentures Inc",
    type: "Innovation Partner",
    icon: <GraduationCap className="w-10 h-10 sm:w-12 sm:h-12 text-indigo-600" />,
  },
];
      ...
      <div className="relative rounded-3xl bg-white/80 backdrop-blur-xl 
        ...
        <div className="flex flex-col items-center text-center gap-4 sm:gap-6">
          ...
          <div>
            ...
            <span className="inline-flex mt-2 sm:mt-3 
...
const Sponsors = () => {
  return (
    ...
    >
      ...
      <section className="pb-20 sm:pb-24 md:pb-28 px-4 sm:px-6 ">
        <motion.div
          ...
          className="max-w-6xl mx-auto 
                     ...
                     sm:grid-cols-2 
                     lg:grid-cols-3 
                     gap-6 sm:gap-8 lg:gap-10 hover:cursor-pointer"
        >
      ...
      <footer className="border-t border-gray-200 py-8 sm:py-10 
